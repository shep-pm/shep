...
The last frame is the secrets pane, `S` from the dashboard, and the one
before it is the full-screen bleats pane, `b`. The seven before those are
the settings screen, `s` from the dashboard. It owns
