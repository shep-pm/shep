...
use self::chrome::{
    column_header_line, hairline_line, has_groups, legend_line, pending_edit_line, tab_row_line,
    title_band_line, title_line,
};
use self::close::draw_close_dialog;
use self::field_row::{field_line, impact_tag, push_wrapped_blurb, section_header, type_label};
use self::layout::{
    BLURB_WRAP, PANEL_MAX, POSITION_W, body_width, clipped, lands_fits_beside_panel, line_columns,
    mask_secret, panel_width, widths, wrap,
};

use super::super::app::App;
use super::super::field::Field;
use super::super::pane::{ConfigPane, EnvTyping, ListPane, ListRow, PaneRow, PaneTarget};
...
mod tests {
    ...
    use super::fixtures::{secret_dog_pane_with_an_edit, secret_list_dog_pane, text_of, web_pane};
    use super::*;
