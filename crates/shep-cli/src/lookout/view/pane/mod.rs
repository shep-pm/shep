...
use self::layout::{
    BLURB_WRAP, PANEL_MAX, POSITION_W, body_width, clipped, cost_label, lands_fits_beside_panel,
    line_columns, mask_secret, panel_width, widths, wrap,
};
...
mod tests {
    ...
    use super::fixtures::{text_of, web_pane};
    use super::*;
