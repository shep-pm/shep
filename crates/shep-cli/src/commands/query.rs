...
mod tests {
    ...
    use shep_client::testing::{
        fake_client_answering, fake_client_capturing_envelopes, fake_client_on,
        fake_client_replying_err, fake_client_with_ack, sample_ack, sample_info,
    };
    use shep_core::protocol::{DogSource, RpcErrorCode};
    ...
    async fn listing(client: &Client, fmt: Format) -> (ExitCode, String) {
        let mut out = Vec::new();
        let mut err = Vec::new();
        let code = {
